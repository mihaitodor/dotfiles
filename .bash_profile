...
# > brew install bash-completion coreutils gnu-tar gnu-sed the_silver_searcher ripgrep gnupg git go python3 broot dust jless homeport/tap/dyff jesseduffield/lazydocker/lazydocker lazygit rustup glow
