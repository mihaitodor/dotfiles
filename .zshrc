...
# > brew install bash-completion coreutils gnu-tar gnu-sed the_silver_searcher fd bat ripgrep jq yq gnupg git go python3 pipx colima docker docker-compose broot mc dua-cli dust jless gron git-delta difftastic homeport/tap/dyff jesseduffield/lazydocker/lazydocker lazygit rustup npm glow libpq pgcli kubectl helm dive mitmproxy maccy
# > pipx install oshit
