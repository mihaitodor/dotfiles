...
# > brew install bash-completion coreutils gnu-tar gnu-sed the_silver_searcher fd ripgrep gnupg git go python3 pipx colima docker docker-compose broot mc dust jless git-delta difftastic homeport/tap/dyff jesseduffield/lazydocker/lazydocker lazygit rustup glow
# > pipx install oshit
