...
# > brew install bash-completion coreutils gnu-tar gnu-sed telnet the_silver_searcher fd bat btop eza ripgrep jq yq gnupg git go gofumpt graphviz python3 uv ruff pipx colima docker docker-compose broot mc dua-cli dust jless gron fzf tokei git-delta difftastic homeport/tap/dyff jesseduffield/lazydocker/lazydocker lazygit rustup npm glow libpq pgcli kubectl kubie helm dive mitmproxy sevenzip maccy
# > pipx install oshit
