...
# > brew install bash-completion the_silver_searcher gnupg git go python3 broot dust homeport/tap/dyff jesseduffield/lazydocker/lazydocker lazygit rustup glow
